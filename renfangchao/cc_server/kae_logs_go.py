...
if __name__ == "__main__":
    ...
    kae = Kae("agent", logger=logger, parse_http_log_catch=parse_http_log_catch)

    result = kae.get_session_reqs_raw("b73b23f83adeb7a50b5db53e2c9979f4 ", 100000, wait=0)
    ...
    r0 = "\n\n".join(r0)
    r1 = "\n-----reqs------\n".join(r1)
    with open("k_logs_go.txt", "w", encoding="utf8") as f:
        f.write(r0)
    with open("k_logs_doc.txt", "w", encoding="utf8") as f:
        f.write(r1)
    # print(r)
