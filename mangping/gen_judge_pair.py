...
from_sheets = ["URL解析", "文件解析", "闲聊", "创作", "脑图", "PPT", "搜索", "长文写作"]
to_sheet = "盲评记录1"
# 模型名，需要是列名的一部分
answer_cols = ["r1", "dpsk32", "qwen"]
...
#                 "问题": row["问题"],
#                 "文件内容": row.get("文件内容"),
#                 "search_1": row.get("search_1"),
#                 "search_2": row.get("search_2"),
#                 "search_3": row.get("search_3"),
#                 "search_4": row.get("search_4"),
#                 "模型A": col1,
#                 "模型B": col2,
...
airsheet.write_xl(head, "P1", sheet_name=to_sheet)
