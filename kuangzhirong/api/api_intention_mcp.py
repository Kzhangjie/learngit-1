...
# WPS_SID_TEST = os.environ.get("WPS_SID_TESTENV")
WPS_SID_TEST = "V02SaSme0P8S0wfzekLL_XLnW3amtuI00a42cbfd0010fa8253"
...
class TableOperationEventHandler:
    """表格操作事件处理器"""
    def can_handle(self, event_data: SSEEventData) -> bool:
        return event_data.event_type == "execution" and  "table_operation_code" == event_data.data_type
...
class DataAnalysisResultEventHandler:
    """数据分析事件处理器"""
    def can_handle(self, event_data: SSEEventData) -> bool:
        return event_data.event_type == "execution" and "st_code" == event_data.data_type
