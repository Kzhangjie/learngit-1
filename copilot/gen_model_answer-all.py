...
#公网url
model_url = "http://120.92.122.107:30818/kas/dbom6w2hcti7nmnmqfdztfxllclc/api/chat/completions?model=lingxi2"
...
from api2 import Copilot
#内网url
cc = Copilot(is_test=True,model_url="http://10.8.254.24:30818/kas/dbom6w2hcti7nmnmqfdztfxllclc/api/chat/completions?model=lingxi2",custom_headers={},search_engines="")
...
if __name__ == '__main__':
    ...
    # ss = [sheetname,sheetname1,sheetname2,sheetname3,sheetname5,sheetname4,sheetname7,sheetname8] #canvas评测
    # ss = [sheetname,sheetname2,sheetname3,sheetname4,sheetname5,sheetname7,sheetname8]
    # ss = [sheetname3,sheetname4,sheetname5,sheetname8,sheetname,sheetname2,sheetname7] #新用例评测
    # ss = [sheetname5]
    for s in ss:
