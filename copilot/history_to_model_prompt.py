...
import json
from copilot.code_session import history_to_chat_messages,history_to_pptmodel_messages
import re    
def run_one(row:dict):
    ...
    messages = history_to_pptmodel_messages(history)
