...
#公网url
model_url = "http://120.92.122.107:30818/kas/ybsjuqhgzi9-qkatvhtcdydnav5x/api/chat/completions?model=canvas"
...
from api2 import Copilot
#内网url
cc = Copilot(is_test=True,model_url="http://10.8.254.24:30818/kas/ybsjuqhgzi9-qkatvhtcdydnav5x/api/chat/completions?model=canvas",custom_headers={},search_engines="")
...
if __name__ == '__main__':
    ...
    ss = [sheetname,sheetname1,sheetname2,sheetname3,sheetname4,sheetname5,sheetname7,sheetname8]
    # ss = [sheetname4,sheetname8]
    for s in ss:
