...
#公网url
model_url = "http://120.92.122.107:30818/kas/bmfcacd11vhnv7crjzzq1y4mnena/api/chat/completions?model=canvas"
...
from api2 import Copilot
#内网url
cc = Copilot(is_test=True,model_url="http://120.92.122.107:30818/kas/bmfcacd11vhnv7crjzzq1y4mnena/api/chat/completions?model=canvas",custom_headers={},search_engines="")
...
if __name__ == '__main__':
    ...
    ss = [sheetname4,sheetname5,sheetname3,sheetname8,sheetname,sheetname2,sheetname7] #canvas用例评测
    # ss = [sheetname8]
    for s in ss:
