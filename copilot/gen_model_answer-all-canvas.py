...
def process_questions(qs, data):
    ...
    for i, q in enumerate(qs_list, start=1):  # 从 1 开始匹配序号
        index = str(i)
        q = q.strip()  # 去除问题前后空格
...
if __name__ == '__main__':
    ...
    ss = [sheetname,sheetname2,sheetname3,sheetname4,sheetname5,sheetname7,sheetname8] #canvas用例评测
    # ss = [sheetname5]  
    for s in ss:
